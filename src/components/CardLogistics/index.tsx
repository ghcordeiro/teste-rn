        ...
        <Body>
          ...
          <Row justifyContent="center">
            <BodyGroupText>
              ...
              <TextRegular size={12}>{`${convertAfterDot(data.ticketBoarding, 0) || 0}`}</TextRegular>
            </BodyGroupText>
            <BodyGroupText>
              <TextRegular size={10}>Finalizados</TextRegular>
              <TextRegular size={12}>{`${convertAfterDot(data.ticketBoardingFinish, 0) || 0}`}</TextRegular>
            </BodyGroupText>
          </Row>
          <Row justifyContent="center">
            <BodyGroupText>
              <TextRegular size={10}>Embarcados Hoje</TextRegular>
              <TextRegular size={12}>{`${convertAfterDot(data.dayTicketBoarding, 0) || 0}`}</TextRegular>
            </BodyGroupText>
            <BodyGroupText>
              <TextRegular size={10}>Finalizados Hoje</TextRegular>
              <TextRegular size={12}>{`${convertAfterDot(data.dayTicketBoardingFinish, 0) || 0}`}</TextRegular>
            </BodyGroupText>
          </Row>
          <Row justifyContent="space-between">
            <BodyGroupText>
            ...
            <BodyGroupText>
              <TextRegular size={12}>Embarcado</TextRegular>
