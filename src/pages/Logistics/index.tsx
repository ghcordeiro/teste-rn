import CardLogistics from '@components/CardLogistics';
...
import { ILogistics, IPositionLogistics } from 'src/dtos/logistics';
...
const Logistics = () => {
  ...
  const getFilters = (filters: ILogisticsFilters): string[] => {
    const { producer, cropCulture, buyerCode, placeNameId, showHistory } = filters;
    const filter: string[] = [];
