...
const PageNotificationNotification = () => {
  ...
  const loadRepositories = useCallback(async () => {
    try {
      ...
      const response = await api.get(
        `mobile-notification/NOTIFICATION/list?skip=${data.length}&limit=${limit}&sort=-createdAt`,
      );
...
export default PageNotificationNotification;
